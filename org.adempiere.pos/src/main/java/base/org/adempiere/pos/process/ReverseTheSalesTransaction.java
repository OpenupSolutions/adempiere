    ...
    private void cancelShipments( MInOut[] sourceShipments)
    {
        for (MInOut sourceShipment : sourceShipments) {
            ...
            for (MInOutLine sourceShipmentLine : sourceShipment.getLines())
            {
                ...
                customerReturnLine.setQtyEntered(sourceShipmentLine.getQtyEntered());//Openup. Nicolas Sarlabos. 24/08/2020. #14444.
                customerReturnLine.setMovementQty(sourceShipmentLine.getMovementQty());//Openup. Nicolas Sarlabos. 24/08/2020. #14444.
